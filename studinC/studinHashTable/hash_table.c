...
{
    const int hash_a = hash_function(s, HT_PRIME_1, num_buckets);
    const int hash_b = hash_function(s, HT_PRIME_2, num_buckets);
...
{
    const int new_size = ht->base_size * (upsize ? 2 : 0.5);
